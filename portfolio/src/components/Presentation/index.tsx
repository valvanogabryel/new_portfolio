...
const Presentation = () => {
  ...
  return (
    ...
    >
      <Fade cascade direction="up" duration={300} triggerOnce delay={1500}>
        <div className="text-primary bg-red-100 bg-opacity-80 dark:bg-red-800 dark:bg-opacity-10 w-auto px-4 py-2 rounded-full duration-150 hover:ring-1 hover:ring-primary hover:ring-opacity-50 mb-4">
      ...
      <div>
        <ul className="flex gap-36 justify-end text-3xl text-slate-400 items-center -ml-10 md:hidden">
          <Fade delay={2000} triggerOnce direction="left">
          ...
          <div className="flex gap-2 ml-auto">
            <JackInTheBox cascade delay={1800} triggerOnce>
